...
var all_dialogues = {
	"part1": [
		{"speaker": "Test", "text": "I hope I get in, even if I sent the form past the deadline."},
		{"speaker": "Test", "text": "But hey!! If the form was still open for submission."},
		{"speaker": "Test", "text": "it must mean they’re still accepting people. That has to be it!!."},
	],
