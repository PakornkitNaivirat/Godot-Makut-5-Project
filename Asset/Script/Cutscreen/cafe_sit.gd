...
var all_dialogues = {
	"part1": [
		...
		{"speaker": "Narrator", "text": "The cafe is called LUCY."},
		{"speaker": "Narrator", "text": "It’s a chill, beach-style cafe with both indoor and outdoor seating,"},
		{"speaker": "Narrator", "text": "located right by the shore."},
		{"speaker": "Narrator", "text": "It took about 6-8 minutes to get there from the university."},
	],
}
