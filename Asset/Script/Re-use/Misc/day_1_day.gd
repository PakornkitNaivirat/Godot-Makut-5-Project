...
var all_dialogues = {
	"part1": [
		{"speaker": "Narrator", "text": "Huh...."},
		{"speaker": "Narrator", "text": "It's morning already??"},
		{"speaker": "Narrator", "text": "Gotta go class right now..."},
	],
}
...
func _ready():
	...
	if Global.D1bed == false: 
		if Global.current_day == 1 and Global.day_night == false:
			if player:
